<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' =>
    'Project', 'url' => route('project.index')], ['name' => $name]]], key('breadcrumb'))
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-4">
                            <img src="{{ asset($project->image ?? 'assets/images/companies/default.png') }}" alt=""
                    ...
                    <div class="text-muted mt-4">
                        <p><i class="mdi mdi-chevron-right text-primary me-1"></i> Category: {{ $project->category->name
                            ?? '-' }}</p>
                        <p><i class="mdi mdi-chevron-right text-primary me-1"></i> Project Manager: {{
                            $projectManagerName ?? '-' }}</p>
                        <p><i class="mdi mdi-chevron-right text-primary me-1"></i> Status: {{ ucfirst(str_replace('_', '
                            ', $status)) }}</p>
                    </div>
