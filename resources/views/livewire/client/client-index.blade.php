<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'client', 'url' => route('client.index')]]], key('breadcrumb'))
    ...
    <div class="row">
        <div class="col-lg">
            @livewire('client.client-list', ['clients' => $clients->getCollection()], key('client-list'))
            {{ $clients->links() }}
        </div>
    </div>
