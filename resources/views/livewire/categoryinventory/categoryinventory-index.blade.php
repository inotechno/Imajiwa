<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'Category Inventory', 'url' => route('category.index')]]], key('breadcrumb'))
    ...
    <div class="row">
        <div class="col-lg">
            @livewire('categoryinventory.categoryinventory-list', ['categories' => $categories->getCollection()], key('categoryinventory-list'))
            {{ $categories->links() }}
        </div>
    </div>
</div>
