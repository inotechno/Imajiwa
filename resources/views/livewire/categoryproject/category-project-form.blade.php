<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'Category Project', 'url' => route('category.index')], ['name' => $type == 'create' ? 'Create' : 'Edit Category Project ']]], key('breadcrumb'))
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">
                        {{ $type == 'create' ? 'Create Category Project' : 'Edit Category Project ' . $category->title }}
                    </h4>
